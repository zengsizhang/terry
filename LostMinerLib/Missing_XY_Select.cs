namespace LostMinerLib
{
    ...
    public class Missing_XY_Select : Form
    {
        ...
        public Missing_XY_Select(string user_id, string line_no, string begin_time, string end_time, string id, string warn_type)
        {
