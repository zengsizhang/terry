namespace LostMinerLib
{
    ...
    public class Missing_ResultUser : Form
    {
        ...
        {
            string sql = "select id '编号', user_id '用户编号',begin_time '检查开始时间',end_time '检查结束时间', warn_type '用户类型',line_no '线路',update_time '确认时间' from ts_warn_user where   warn_type='漏计'  order by id desc ";
        ...
        {
            string sql = "select id '编号', user_id '用户编号',begin_time '检查开始时间',end_time '检查结束时间', warn_type '用户类型',line_no '线路',update_time '确认时间' from ts_warn_user WHERE warn_type='漏计'  ";
