           ...
           // end_time="2014-03-04T00:00:00";
            ...
            try
            {
                ...
                for (int i = 0; i < user_dt.Rows.Count; i++)
                {
                  ...
                  FileStream myFs1 = new FileStream("moniterr.xml", FileMode.Create);
                  ...
                  myFs1.Close();  
                    ...
                    xmlres = xmlres + ddd;
                    FileStream myFs = new FileStream("moniter.xml", FileMode.Create);
                ...
                StreamWriter sw = new StreamWriter("webi.log");
                    ...
                    sw.WriteLine("读取接口数据从:" + webdtbeg + " 至" + webdtend);
                    sw.WriteLine("数据转换从:"+datecbeg+"至"+datecend);
                    sw.WriteLine("-------------------");
                    sw.WriteLine(txt);
